...
class Sql2oCandidateRepositoryTest {
    ...
    public void whenSaveThenGetSame() {
        var candidate = sql2oCandidateRepository.save(new Candidate(0, "name", "description", file.getId()));
    ...
    public void whenSaveSeveralThenGetAll() {
        ...
        var candidate1 = sql2oCandidateRepository.save(new Candidate(0, "name1", "description1", file.getId()));
        var candidate2 = sql2oCandidateRepository.save(new Candidate(0, "name2", "description2", file.getId()));
        var candidate3 = sql2oCandidateRepository.save(new Candidate(0, "name3", "description3", file.getId()));
    ...
    public void whenUpdateThenGetUpdated() {
        ...
        var updatedCandidate = new Candidate(
                candidate.getId(), "new name", "new description", file.getId()
        );
    ...
    public void whenUpdateUnExistingVacancyThenGetFalse() {
        var candidate = new Candidate(0, "name", "description", file.getId());
